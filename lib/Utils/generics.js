...
exports.isWABusinessPlatform = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestVelyxVersion = exports.fetchLatestBaileysVersion = exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.generateMessageIDV2 = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeNewsletterMessage = exports.encodeWAMessage = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.getPlatformId = exports.Browsers = void 0;
...
const wa_version_json_1 = require("../Defaults/wa-version.json");
...
const fetchLatestVelyxVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://raw.githubusercontent.com/yusrilannuriz-vip/Baileys/main/package.json', {
            ...options,
            responseType: 'json'
        });
        const versionStr = String((data === null || data === void 0 ? void 0 : data.version) || '2.1.0').replace(/^v/, '');
        const parsed = versionStr.split('.').slice(0, 3).map(part => parseInt(part, 10));
        if (parsed.length !== 3 || parsed.some(Number.isNaN)) {
            throw new Error('Invalid Velyx version in GitHub package.json');
        }
        return { version: parsed, isLatest: true };
    } catch (error) {
        return { version: [2, 1, 0], isLatest: false, error };
    }
};
exports.fetchLatestVelyxVersion = fetchLatestVelyxVersion;

const fetchLatestBaileysVersion = async (options = {}) => {
    // Keep the familiar Baileys API, but resolve the active WhatsApp Web version
    // instead of querying an unrelated npm package.
    return (0, exports.fetchLatestWaWebVersion)(options);
};
...
const fetchLatestWaWebVersion = async (options) => {
    try {
        ...
        if (!(match === null || match === void 0 ? void 0 : match[1])) {
            return {
                version: wa_version_json_1.version,
                isLatest: false,
                error: {
